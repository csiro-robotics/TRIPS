...
declare EXP_NAME='MSL_MOV_DIST_w_'$NUM_OF_EXEMPLAR'_exemplar_'$BACKBONE_name'_default_lr_optimizer_0_iid'$hparam_LOSS_lambda_c'_'$hparam_LOSS_lambda_d'_loss'
